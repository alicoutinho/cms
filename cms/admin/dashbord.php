            ...
            <div id="sidebar" class="nav-collapse ">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="sub-menu">
                        <a href="javascript:;" class="">
                            <i class="icon-book"></i>
                            <span>مدیریت ویجت زیراسلاید</span>
                            <span class="arrow"></span>
                        </a>
                        <ul class="sub">
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            <li><a class="" href="dashbord.php?m=news&p=list">لیست خبرها</a></li>
                    ...
                    <li class="sub-menu">
                        <a href="javascript:;" class="">
                            <i class="icon-book"></i>
                            <span>مدیریت اپلودها</span>
                            <span class="arrow"></span>
                        </a>
                        <ul class="sub">
                            <li><a class="" href="dashbord.php?m=uploader&p=list">لیست </a></li>
                            <li><a class="" href="dashbord.php?m=uploader&p=add">افزودن اپلود جدید</a></li>
                        </ul>
                    </li>
